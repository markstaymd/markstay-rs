...
as §3.4 permits. The §16 compatibility rules above still apply to child-stamped
input. The optional `OUTSIDE_SUBSET` advisory requires a §5.2 parser and is not
implemented by this parser-free core.
