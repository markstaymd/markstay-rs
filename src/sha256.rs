// Vendored SHA-256 (FIPS 180-4), public domain.
//
// Source: a standard textbook implementation of the SHA-256 compression
// function; the algorithm is defined by NIST FIPS PUB 180-4 and is not
// copyrightable. This file may be treated as public domain (CC0-1.0); it carries
// no third-party copyright.
//
// markstay's Python and JS references get SHA-256 from their standard libraries
...
/// SHA-256 of `data`, returned as a 64-character lowercase hex string.
